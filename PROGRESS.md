...
**93 chapters total.** One chapter every couple of days is a sustainable pace.

Copy this file (or just tick the boxes in your own fork) and check off each chapter as you finish it. "Finished" means you read it, ran the code, and did at least the mini-project. Do not just read. Build.

There are checkpoints in [CHECKPOINTS.md](CHECKPOINTS.md) at the end of each stage to test that you are really ready to move on.
