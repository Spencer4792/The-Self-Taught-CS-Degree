...
This is the reading order. Work through it top to bottom and every chapter builds on the ones before it. The folder numbers are just stable labels for storage; this file is the real curriculum, arranged from easiest to hardest. (It is also compatible with mdBook if you ever want to render the whole thing as a book site.)

[Introduction and full table of contents](README.md)
[Study Guide: tracks, schedules, resources](STUDY-GUIDE.md)
[Progress Tracker](PROGRESS.md)
[Project and Portfolio Index](PROJECTS.md)
[Stage Checkpoints](CHECKPOINTS.md)

# Stage 0: Get set up

- [0.1 Setup and Tooling](00-Orientation/00.1-setup-and-tooling.md)
- [0.2 Programming Fundamentals (starting from zero)](00-Orientation/00.2-programming-fundamentals.md)
- [0.3 Problem-Solving and Computational Thinking](00-Orientation/00.3-problem-solving.md)
...
- [27.1 Clean Code, SOLID and Design Patterns](27-Software-Engineering/27.1-clean-code-and-design-patterns.md)
...
# Appendix (reference, use anytime)

- [28.1 Cheat Sheets](28-Appendix/28.1-cheat-sheets.md)
- [28.2 Glossary](28-Appendix/28.2-glossary.md)
